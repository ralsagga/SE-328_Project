...
public class DeleteRecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initWidgets() {
        ...
        deleteButton = findViewById(R.id.btn_delete_record);
    ...
    private void initProgressBar() {
        progressDialog = new ProgressDialog(DeleteRecordActivity.this);
    ...
    public void onClick(View view) {
        ...
        if (view == deleteButton) {
            try {
                ...
                FirebaseDatabaseHelperClass.deleteStudent(student);
                HelperClass.success(getApplicationContext(), "Record deleted successfully");
                finish();
                progressDialog.dismiss();
            } catch (Exception e) {
                progressDialog.dismiss();
